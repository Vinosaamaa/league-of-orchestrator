...
def source_contract(source: Path) -> bytes:
    ...
    for required_clause in (
        ...
        "already notified at the unchanged wait generation ends quietly.",
        "New captured steering rearms the reminder.",
        "This does not complete work, acknowledge delivery, pause Champions, "
        "or claim a healthy supervisor handoff.",
