...
- [#3: Deliver the exact Champion transition without pending-event cross-wiring](https://github.com/Vinosaamaa/league-of-orchestrator/issues/3) — grouped repository-local candidate with #4, #5, and #17
- [#4: Enforce explicit direct, hidden, or Champion dispatch before work](https://github.com/Vinosaamaa/league-of-orchestrator/issues/4) — grouped repository-local candidate with #3, #5, and #17
- [#5: Add bounded Stop-hook and Shotcaller wake continuity](https://github.com/Vinosaamaa/league-of-orchestrator/issues/5) — grouped repository-local candidate with #3, #4, and #17
...
- [#17: Add a durable request inbox and unresolved-work reconciliation](https://github.com/Vinosaamaa/league-of-orchestrator/issues/17) — grouped repository-local candidate with #3, #4, and #5
...
import, hook, watcher-replacement, canary, or cutover gates. The filesystem
baseline remains live until one coherent release is separately authorized and
verified.
