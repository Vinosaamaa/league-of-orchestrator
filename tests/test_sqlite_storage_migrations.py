...
def test_transactional_upgrade_backup_and_rollback(root: Path) -> None:
    ...
    with SQLiteStorage.for_migration(state) as store:
        ...
        assert MIGRATIONS[-5].name == "advisory-project-catalog-and-roster-indexes"
        assert MIGRATIONS[-5].checksum == "5477db9879d6a4a9a29bb8188b398bd6db9a7a786e40e86ab819a0a938790faf"
        assert MIGRATIONS[-4].name == "guarded-rollover-and-shuffled-callsign-queue"
        assert MIGRATIONS[-4].checksum == "879ef4addfe6725e31c31a5aa1db9078d7c066a26610eaa2753f749c6e53ab75"
        assert MIGRATIONS[-3].name == "bounded-reporting-and-outbound-privacy"
        assert MIGRATIONS[-3].checksum == "bebe90eb841eac2a0b42d3f89e321cb4f3f8b23b02d92febf5a4ea2a50727cde"
        assert MIGRATIONS[-2].name == "bounded-routing-policy-and-request-progress"
        assert MIGRATIONS[-2].checksum == "593e2cf05d0200463800b6be7cbf5918a9b5fc3304f793d2ec3fad30b538e80c"
        assert MIGRATIONS[-1].name == "repository-owned-artifact-publication"
        assert MIGRATIONS[-1].checksum == "9231da781de45a8e912cd7193034a0b1b56f3a13e5e737e5681f18f6c6e3c852"
