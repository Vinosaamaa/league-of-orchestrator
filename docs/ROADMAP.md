...
- [#81: Implement durable scoped autonomous delivery mode](https://github.com/Vinosaamaa/league-of-orchestrator/issues/81) — this candidate adds immutable grant revisions, exact bounded action/repair receipts, six stable mode commands, Shotcaller-only external ownership, issue-first `assign run`, and generic visible-Champion routing for durable work; merge/install/live acceptance remain separate gates
