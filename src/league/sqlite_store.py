...
class SQLiteStorage(SQLiteTransactionCore):
    ...
    def prompt_triage_policy(self, owner_agent_id: str) -> dict[str, Any]:
        from .sqlite_prompt_triage_ops import policy
        return policy(self, owner_agent_id)

    def configure_prompt_triage(
        self, owner_agent_id: str, enabled: bool, expected_version: int, at: str
    ) -> dict[str, Any]:
        from .sqlite_prompt_triage_ops import configure
        return configure(self, owner_agent_id, enabled, expected_version, at)
    ...
    def reconcile_restored_runtime(
        ...
        *, recover_observed_failure: bool = False, expected_owner_agent_id: str | None = None,
        ...
        return sqlite_runtime_ops.reconcile_restored_runtime(
            ...
            expected_owner_agent_id=expected_owner_agent_id,
